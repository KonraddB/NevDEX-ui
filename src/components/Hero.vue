<template>
  <div class="flex flex-col text-center mass-header z-10 md:p-0 p-5">
    ...
    <div class="z-10 flex flex-col">
      ...
      <span class="text-gray-400 hover: text-xl md:mt-10 mt-20">
      ...
      <div class="flex justify-center items-start">
        <router-link to="trade"> <button class="text-gray-50 md:mt-40 mt-20 px-10 py-5 bg-gray-800 font-bold hover:bg-gray-500 rounded-md">Trade Now</button></router-link>
      </div>
